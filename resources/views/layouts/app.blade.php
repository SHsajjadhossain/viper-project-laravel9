    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div class="user-box">
                    <div class="user-img">
                        <img src="{{ asset('uploads/profile_photoes').'/'.Auth::user()->profile_photo }}" alt="user-img"
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-bar-graph-2"></i><span> Charts </span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
        ...
        <div class="content-page">
            ...
            <footer class="footer text-right">
                {{ \carbon\carbon::today()->format('Y') }} © Viper. - www.viper.com
            </footer>
